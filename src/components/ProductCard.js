  ...
  return (
    ...
    >
      {pathname.includes("cart") &&
        <div className="bg-indigo-500 absolute top-2 right-2 text-white rounded-full h-8 w-8">
      ...
      <div className='flex gap-2 mt-5'>
        {pathname.includes("cart") && <button
          ...
          className='bg-red-500 rounded-full py-1 flex-1 flex px-4 justify-between items-center text-white text-bold'>
